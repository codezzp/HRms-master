...
<body>
	<div id="container">
		...
		<div id="content">
			<form action="Staff_update_control" method="post">
				<div
				...
				<table width="100%" border="0px solid #FFFFFF"
					...
					<tr>
						...
						<td width="30%"><input type="text" name="id" class="input"
							disabled="disabled" style="background-color: #F0F0F0;" />
						</td>
						<td width="20%">员工性别：</td>
					...
					<tr>
						<td width="20%">员工年龄：</td>
						<td width="30%"><input type="text" name="age" class="input" />
						</td>
						<td width="20%">所属部门：</td>
						<td width="30%"><input type="text" name="department"
							class="input" /></td>
					</tr>
					<tr>
						<td width="20%">所任职位：</td>
