			...
			<form action="Staff_insert_control" method="post">
				<table width="100%" border="0px solid #FFFFFF"
					...
					<tr>
						...
						<td width="20%">员工姓名：</td>
						<td width="30%"><input type="text" name="name" class="input" />
						</td>
					</tr>
					<tr>
						<td width="20%">员工性别：</td>
						<td width="30%"><input type="text" name="sex" class="input" />
						</td>
						<td width="20%">员工年龄：</td>
						<td width="30%"><input type="text" name="age"
							class="input" />
						</td>
					</tr>
					<tr>
						<td width="20%">所属部门：</td>
						<td width="30%"><input type="text" name="department" class="input" />
						</td>
						<td width="20%">所任职位：</td>
						<td width="30%"><input type="text" name="position"
							class="input" />
						</td>
					</tr>
					<tr>
						<td width="20%">薪酬情况：</td>
						<td width="30%"><input type="text" name="salary" class="input" />
						</td>
					</tr>
				</table>
