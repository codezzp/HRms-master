					...
					<%
						...
						if (db1.createConn()) {
							...
							while (db1.next()) {
								...
								out.println("<td>" + db1.getValue("name") + "</td>");
								out.println("<td>" + db1.getValue("sex") + "</td>");
								out.println("<td>" + db1.getValue("age") + "</td>");
								out.println("<td>" + db1.getValue("department") + "</td>");
								out.println("<td>" + db1.getValue("position") + "</td>");
								out.println("<td>" + db1.getValue("salary") + "</td>");
								out.println("</tr>");
							}
							db1.closeRs();
							db1.closeStmt();
