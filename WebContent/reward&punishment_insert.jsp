		...
		<div id="menu">
			...
			<p>
				<input type="button" id="query" value="查询" class="menu_button"
					...
					onclick="javascript:window.location.href='reward&punishment_query.jsp'">
				<input type="button" id="insert" value="添加 >" class="menu_button"
					onmousedown="changeBC('insert')" onmouseup="originalBC('insert')"
					onclick="javascript:window.location.href='reward&punishment_insert.jsp'">
				...
				<input type="button" id="delete" value="删除" class="menu_button"
					...
					onclick="javascript:window.location.href='reward&punishment_delete.jsp'">
		</div>

		<div id="content">
			<form action="Rewardandpunishment_insert_control" method="post">
				<table width="100%" border="0px solid #FFFFFF"
					style="margin-top: 20px; text-align: center;">
					<tr>
						<td width="20%">奖惩信息编号：</td>
						<td width="30%"><input type="text" name="id" class="input"
							disabled="disabled" style="background-color: #F0F0F0;" />
						</td>
						<td width="20%">奖惩对象姓名：</td>
						<td width="30%"><input type="text" name="name" class="input" />
						</td>
					</tr>
					<tr>
						<td width="20%">奖惩性质：</td>
						<td width="30%"><input type="text" name="category"
							class="input" /></td>
						<td width="20%">奖惩内容：</td>
